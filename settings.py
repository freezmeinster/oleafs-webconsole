...
DATABASES = {
    'default': {
        ...
        'NAME': 'webconsole.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(PROJECT_ROOT,"assets/user/")
...
SUIT_CONFIG = {
    'ADMIN_NAME': 'Tenriola Cloud Operation',

  
    'SEARCH_URL': '/admin/cloud/cloud/',
    'MENU_ICONS': {
        'sites': 'icon-leaf',
        'auth': 'icon-lock',
    },
