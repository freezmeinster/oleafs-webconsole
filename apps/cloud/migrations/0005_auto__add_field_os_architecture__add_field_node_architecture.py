...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OS.architecture'
        db.add_column(u'cloud_os', 'architecture',
                      self.gf('django.db.models.fields.CharField')(default='i368', max_length=4),
                      keep_default=False)

        # Adding field 'Node.architecture'
        db.add_column(u'cloud_node', 'architecture',
                      self.gf('django.db.models.fields.CharField')(default='i368', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OS.architecture'
        db.delete_column(u'cloud_os', 'architecture')

        # Deleting field 'Node.architecture'
        db.delete_column(u'cloud_node', 'architecture')
