...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cloud.is_created'
        db.add_column(u'cloud_cloud', 'is_created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Cloud.run_state'
        db.add_column(u'cloud_cloud', 'run_state',
                      self.gf('django.db.models.fields.CharField')(default='stop', max_length=255),
                      keep_default=False)

        # Adding unique constraint on 'Cloud', fields ['ip_address', 'mac_address']
        db.create_unique(u'cloud_cloud', ['ip_address', 'mac_address'])


    def backwards(self, orm):
        # Removing unique constraint on 'Cloud', fields ['ip_address', 'mac_address']
        db.delete_unique(u'cloud_cloud', ['ip_address', 'mac_address'])

        # Deleting field 'Cloud.is_created'
        db.delete_column(u'cloud_cloud', 'is_created')

        # Deleting field 'Cloud.run_state'
        db.delete_column(u'cloud_cloud', 'run_state')
