...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cloud.vnc_port'
        db.add_column(u'cloud_cloud', 'vnc_port',
                      self.gf('django.db.models.fields.IntegerField')(default=5900),
                      keep_default=False)

        # Adding field 'Cloud.websocket_port'
        db.add_column(u'cloud_cloud', 'websocket_port',
                      self.gf('django.db.models.fields.IntegerField')(default=6080),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cloud.vnc_port'
        db.delete_column(u'cloud_cloud', 'vnc_port')

        # Deleting field 'Cloud.websocket_port'
        db.delete_column(u'cloud_cloud', 'websocket_port')
